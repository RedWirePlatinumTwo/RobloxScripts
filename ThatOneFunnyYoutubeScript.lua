...
local function tween(pos)
    pos = pos * Vector3.new(1, 0, 1) + Vector3.new(0, root.Position.Y, 0)
    game.TweenService:Create(root, TweenInfo.new(0.3), {CFrame = CFrame.new(root.Position, root.Position + pos)}):Play()
end
